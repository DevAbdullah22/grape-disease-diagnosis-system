        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextDoseAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreatmentExecutions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TreatmentExecutions_Diagnoses_DiagnosisId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentExecutions_DiagnosisId",
                table: "TreatmentExecutions",
                column: "DiagnosisId");
